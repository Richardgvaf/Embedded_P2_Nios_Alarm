...
int * TIMER = (int*) 0x2800;
int * PH = (int*) 0x280c;
int * PL = (int *) 0x2808;
int * TC = (int *) 0x2804;
int * SSEG0 = (int*) 0x2880;
int * SSEG1 = (int*) 0x2870;
int * SSEG2 = (int*) 0x2860;
int * SSEG3 = (int*) 0x2850;
int * SWITCHES = (int*) 0x2840;
int * LEDS = (int*) 0x2830;
int * BUTTON = (int*) 0x2820;
	...
	while (1) {
		...
		/*else if(segundos==60){
		 ...
		 minutos=minutos+1;
			...
			if (alarma == 1 && horas2 == nahoras2 && horas == nahoras
					&& minutos2 == naminutos2 && minutos == naminutos) {
				*LEDS = 0xff;
			} else {
				DECO();
