...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/prueba1_tb/simulation/submodules/verbosity_pkg.sv"              -work altera_common_sv_packages                          
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/prueba1_tb/simulation/submodules/altera_avalon_reset_source.sv" -work prueba1_inst_reset_bfm                             
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/prueba1_tb/simulation/submodules/altera_conduit_bfm_0002.sv"    -work prueba1_inst_led_output_5_external_connection_bfm  
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/prueba1_tb/simulation/submodules/altera_avalon_clock_source.sv" -work prueba1_inst_clk_bfm                               
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/prueba1_tb/simulation/submodules/altera_conduit_bfm.sv"         -work prueba1_inst_button_input_1_external_connection_bfm
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/prueba1_tb/simulation/prueba1_tb.v"                                                                                      
fi
