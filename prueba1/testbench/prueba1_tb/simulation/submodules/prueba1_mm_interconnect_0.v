...
`timescale 1 ps / 1 ps
module prueba1_mm_interconnect_0 (
	...
	wire  [89:0] jtag_avalon_jtag_slave_agent_rf_source_data;                               // JTAG_avalon_jtag_slave_agent:rf_source_data -> JTAG_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] jtag_avalon_jtag_slave_agent_rsp_fifo_out_data;                            // JTAG_avalon_jtag_slave_agent_rsp_fifo:out_data -> JTAG_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> JTAG_avalon_jtag_slave_agent:cp_data
	...
	wire  [89:0] reg_s1_agent_rf_source_data;                                               // REG_s1_agent:rf_source_data -> REG_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] reg_s1_agent_rsp_fifo_out_data;                                            // REG_s1_agent_rsp_fifo:out_data -> REG_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> REG_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // REG_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> REG_s1_agent:cp_channel
	...
	wire  [88:0] jtag_avalon_jtag_slave_agent_rp_data;                                      // JTAG_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [88:0] reg_s1_agent_rp_data;                                                      // REG_s1_agent:rp_data -> router_005:sink_data
	...
	prueba1_mm_interconnect_0_router router (
	...
	prueba1_mm_interconnect_0_router_001 router_001 (
	...
	prueba1_mm_interconnect_0_router_002 router_002 (
	...
	prueba1_mm_interconnect_0_router_002 router_003 (
	...
	prueba1_mm_interconnect_0_router_002 router_004 (
	...
	prueba1_mm_interconnect_0_router_005 router_005 (
	...
	prueba1_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	prueba1_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
